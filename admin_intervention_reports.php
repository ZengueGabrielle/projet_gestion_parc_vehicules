...
<body>
    ...
    <div class="main-content">
        <nav class="sidebar">
            <div class="user-p">
                <img src="https://images.unsplash.com/photo-1721332153282-2bd0aa3b99ed?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfZ2VyZQ%3D%3D" alt="User Image">
        ...
        <div class="content">
            <div class="dashboard-container">
                ...
                <p>Consultez et modifiez les rapports d’intervention.</p>
            </div>
        </div>
    </div>
    <script>
