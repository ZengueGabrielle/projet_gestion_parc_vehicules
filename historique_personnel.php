...
$stmt = $pdo->prepare("
    SELECT a.id, v.marque, v.modele, a.date_debut, a.date_fin
    FROM affectations a
            ...
            <div class="dashboard-container">
                ...
                <?php if (count($historique) > 0): ?>
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($historique as $affectation): ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($affectation['marque'] . ' ' . $affectation['modele']); ?></td>
                                    <td><?php echo date('d/m/Y', strtotime($affectation['date_debut'])); ?></td>
                                    <td><?php echo $affectation['date_fin'] ? date('d/m/Y', strtotime($affectation['date_fin'])) : 'En cours'; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
                <?php else: ?>
                    <p>Aucun historique d'affectation trouvé.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
