...
try {
    ...
    // Format pour le FullCalendar
    $events = [];
    foreach ($interventions as $intervention) {
        $events[] = [
            'title' => htmlspecialchars($intervention['immatriculation'] . ' - ' . $intervention['description']),
...
<body>
    ...
    <div class="main-content">
        <nav class="sidebar">
            <div class="user-p">
                <img src="https://images.unsplash.com/photo-1721332153282-2bd0aa3b02bd99ed?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="User Image">
