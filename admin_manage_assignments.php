...
<body>
    <video class="background-video" autoplay loop muted playsinline>
        ...
        Votre navigateur ne supporte pas la lecture de vidéos videos.
    </video>
    <header class="header">
    ...
    <div class="main-content">
        <nav class="sidebar">
            ...
            <ul>
                ...
                <li><a href="admin_manage_employees.php"><i class="fas fa-user-friends"></i> <span>Gestion des employés</span></a></a>
                <li><a href="admin_manage_vehicles.php"><i class="fas fa-car"></i> <span>Gestion des véhicules</span></a></li>
                <li><a href="admin_maintenance_alerts.php"><i class="fas fa-exclamation-triangle"></i> <span>Alertes maintenance</span></a></a>
                <li><a href="admin_ia_suggestions.php"><i class="fas fa-brain"></i> <span>Suggestions IA</span></a></a></li>
                <li><a href="admin_intervention_calendar.php"><i class="fas fa-calendar"></i> <span>Calendrier des interventions</span></a></li>
                <li><a href="admin_vehicle_diagnostostics.php"><i class="fas fa-stethoscope"></i> <span>Diagnostic de véhicule</span></a></a>
                <li><li><a href="admin_manage_parts.php"><i class="fas fa-box"></i> <span>Gestion des pièces</span></a></li>
                ...
                <li><a href="admin_incident_tracking.php"><i class="fas fa-shield-alt"></i> <span>Suivi des incidents</span></a></a>
                </li>
        ...
        <div class="content">
            <div class="dashboard-container">
                ...
                <p>Gérez les affectations des véhicules aux utilisateurs.</p>
            </div>
        </div>
    </div>
    </div>
