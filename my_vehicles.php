...
try {
    $stmt = $pdo->prepare("SELECT v.*, i.chemin_image, a.date_debut FROM affectations a 
...
<head>
    ...
    <title>Mes automobiles Assignés</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="container">
                <h2>Mes automobiles Assignés</h2>
                <?php if (isset($error)): ?>
                    <div class="error"><?php echo htmlspecialchars($error); ?></div>
                <?php endif; ?>
                <?php if (empty($vehicles)): ?>
                    <p style="text-align: center;">Aucune voiture assignée.</p>
                <?php else: ?>
                    <table>
                        <tr>
                            <th>Image</th>
                            ...
                            <tr>
                                <td>
                                    <?php if ($vehicle['chemin_image']): ?>
                                        <img src="<?php echo htmlspecialchars($vehicle['chemin_image']); ?>" alt="Voiture" class="vehicle-img">
                                    <?php else: ?>
                                        <img src="assets/images/no-image.png" alt="Pas d'image" class="vehicle-img">
                                    <?php endif; ?>
                                </td>
                                ...
                                <td><?php echo htmlspecialchars($vehicle['date_debut']); ?></td>
                                <td><?php echo htmlspecialchars($vehicle['statut']); ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </table>
                <?php endif; ?>
