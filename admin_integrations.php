...
<head>
    ...
    <title>Intégrations Externes</title>
...
<body>
    <video class="background-video" autoplay loop muted playsinline>
        ...
        Votre serveur ne supporte pas la lecture de vidéos.
    </video>
    <header class="header">
    ...
    <div class="main-content">
        <nav class="sidebar">
            ...
            <ul>
                ...
                <li><a href="admin_maintenance_alerts.php"><i class="fas fa-exclamation-triangle"></i> <span>Alertes maintenance</span></li>
                ...
                <li><a href="admin_manage_parts.php"><i class="fas fa-box"></i> <span>Gestion des pièces</span></li>
                ...
                <li><a href="admin_intervention_reports.php"><i class="fas fa-file-alt"></i> <span>Rapport d’intervention</span></li>
                ...
                </li><li><a href="admin_manage_backups.php"><i class="fas fa-database"></i> <span>Gestion des sauvegardes</span></a></a>
                <li><li><a href="admin_reports.php"><i class="fas fa-file-excel"></i> <span>Rapports globaux</span></a></li>
                <li><li><a href="dashboard_admin.php"><i class="fa fa-home"></i> <span>Retour au tableau de bord</span></a></li>
        ...
        <div class="content">
            <div class="dashboard-container">
                ...
                <p>Configurez des intégrations avec des outils externes.</p>
            </div>
        </div>
    </div>
    </div>
